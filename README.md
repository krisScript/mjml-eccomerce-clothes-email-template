# Eccomerce Email Template

Build with mjml.
Logo provided by [Acme Logos](http://acmelogos.com/).
Transparent Images provided by [Stickpng](http://www.stickpng.com/).


### Prerequisites


Install  [MJML vscode extension](https://marketplace.visualstudio.com/items?itemName=attilabuti.vscode-mjml)

### Getting Started
#### MJML Extension Commands
